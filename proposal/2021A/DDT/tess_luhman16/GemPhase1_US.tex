...
For $K=8.8$ we expect and IQ70, we expect 220 second exposure times.  For an ABBA quad, that is 15 minutes of on-sky integration time.  With 5 visits and overhead we expect a grand total of 1.5 hours of program time.  
