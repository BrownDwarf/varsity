...
Last month Apai et al. 2021 presented the \emph{TESS} lightcurve of the nearest known brown dwarf system, Luhman 16AB; residing at a mere 2 pc from the Sun, it is our third closest neighbor. The proximity of this ultracool L7.5/T0.5 pair makes them the latest spectral type objects amenable to contemporaneous TESS monitoring and high fidelity ground-based observations.  Previous spatially resolved observations (Buenzli et al. 2015) showed that Luhman 16 A has weak to no variability but Luhman 16 B has a $>10\%$ variability in the near infrared.  It was not clear what the TESS lightcurve would show.  Remarkably, the Sector 10 TESS lightcurve of Luhman 16 shows over 100 rotations with global peak-to-valley cloud-induced variations over 25 days exceeding 15\% (Figure 1).  The long-term variations can be attributed to cloud pattern changes driven by atmospheric circulation.  However, due to the lack of simultaneous spectroscopic data, how much the cloud opacity, thickness, and particle size changed is unknown.

Gemini did not observe Luhman 16 contemporaneously with TESS Sector 10 (March 26 - April 22, 2019).  We missed a key opportunity before, but will not miss it this time-- simultaneous TESS monitoring will allow us to know the rotational phase, and when coupled with high-resolution spectroscopy, we can disentangle the A/B components and variability by observing the spectral changes due to variations in cloud opacities.
